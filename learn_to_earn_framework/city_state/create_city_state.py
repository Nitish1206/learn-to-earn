...
from .generate_state_matrices import StateData
...
class CityStateCreator(object):
    ...
    def __init__(self, config_):
        ...
        self.time_slice_duration = self.config["city_state_creator"]["time_slice_duration"]
        self.time_unit_duration = self.config["city_state_creator"]["time_unit_duration"]
    ...
    def get_city_states(self):
        ...
        business_hours_start = self.config['city_state_creator']['business_hours_start']
        business_hours_end = self.config['city_state_creator']['business_hours_end']
